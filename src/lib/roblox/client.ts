...
const BRIDGE_URL = (import.meta.env.VITE_STUD_API_URL as string | undefined) ?? "http://localhost:3001"
const TIMEOUT_MS = 60000 // 60 seconds per request - allows complex operations
